...
class FullExamTransformer extends TransformerAbstract
{
    ...
    protected $defaultIncludes = ['subQuestion'];
    ...
    public function includeSubQuestion()
    {

        $subQuestion = $this->question->subQuestion;

        return $subQuestion ? $this->collection($subQuestion, new ShortExamTransformer) : null;
    }
}