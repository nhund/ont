...
//            try {
                foreach ($items as $key => $item) {
                    ...
                    if (isset($items[0])) {
                        ...
                        if (strpos($item[1], '#f.') !== false) {
                            ...
                            if (count($trac_nghiem) > 0) {
                                $this->_saveTracNghiem($trac_nghiem, $this->data['lesson_id']);
                                $trac_nghiem = [];
                            }
                        ...
                        if (strpos($item[1], '#mf.') !== false) {
                            ...
                            if (strpos($item[1], '#mf.') !== false) {
                                ...
                                $flash_chuoi['user_id']    = $this->data['user_id'];
                                $flash_chuoi['lesson_id']  = $this->data['lesson_id'];
                                $flash_chuoi['course_id']  = $this->data['course_id'];
                        ...
                        if (strpos($item[1], '#q.') !== false) {
                            ...
                            $dien_tu_ngan['user_id']   = $this->data['user_id'];
                            $dien_tu_ngan['lesson_id'] = $this->data['lesson_id'];
                            $dien_tu_ngan['course_id'] = $this->data['course_id'];
                        ...
                        if (strpos($item[1], '#tn.') !== false) {
                            ...
                            $trac_nghiem['user_id']        = $this->data['user_id'];
                            $trac_nghiem['explain_before'] = $formatData['explain_before'];
                            $trac_nghiem['interpret']      = $formatData['interpret'];
                            $trac_nghiem['lesson_id']      = $this->data['lesson_id'];
                            $trac_nghiem['course_id']      = $this->data['course_id'];
                    ...
                    if (strpos($item[1], '#dt.') !== false) {
                        ...
                        $dien_tu_doan_van['user_id']        = $this->data['user_id'];
                        $dien_tu_doan_van['explain_before'] = $formatData['explain_before'];
                        $dien_tu_doan_van['image']          = $formatData['image'];
                        $dien_tu_doan_van['lesson_id']      = $this->data['lesson_id'];
                        $dien_tu_doan_van['course_id']      = $this->data['course_id'];
                    }
