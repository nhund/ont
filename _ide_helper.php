 ...
 * Generated for Laravel 5.8.33 on 2019-09-03 11:36:56.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Request {
        ...
        {
                        return \Illuminate\Http\Request::oauthClient();
        }
        ...
        {
                        return \Illuminate\Http\Request::timezone();
        }
...
namespace Maatwebsite\Excel\Facades { 
    ...
    class Excel {
        ...
        {
                        /** @var \Maatwebsite\Excel\Excel $instance */
                        return $instance->store($export, $filePath, $disk, $writerType);
        }
        ...
        {
                        /** @var \Maatwebsite\Excel\Excel $instance */
                        return $instance->queue($export, $filePath, $disk, $writerType);
        }
...
namespace Spatie\Fractal { 
    ...
    class FractalFacade {
         ...
         *
         * @param string $message
         * @return \App\Support\Fractal
         * @static
         */
        public static function addMessage($message = null)
        {
            /** @var \App\Support\Fractal $instance */
        ...
        {
            //Method inherited from \Spatie\Fractal\Fractal
            return \App\Support\Fractal::create($data, $transformer, $serializer);
        }
        ...
        {
            //Method inherited from \Spatie\Fractal\Fractal
            \App\Support\Fractal::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Spatie\Fractal\Fractal
            \App\Support\Fractal::mixin($mixin);
        }
        ...
        {
            //Method inherited from \Spatie\Fractal\Fractal
            return \App\Support\Fractal::hasMacro($name);
        }
         ...
         * @static
         */
        public static function formatDataForApiResponse($data = array(), $customMessage = '', $statusCode = null, $error = false)
        {
            /** @var \App\Support\Fractal $instance */
            return $instance->formatDataForApiResponse($data, $customMessage, $statusCode, $error);
        }
