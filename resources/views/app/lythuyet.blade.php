...
<head>
    ...
    <!---------------- CSS ----------------->
    <link href='{{ web_asset('public/app/css/ly_thuyet.css') }}' rel='stylesheet' type='text/css'  media='all'  />
</head>
<body>
...
<script src='{{ web_asset('public/app/js/ly_thuyet.js') }}' type='text/javascript'></script>
