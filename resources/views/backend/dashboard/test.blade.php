...
<divv id="container">       
	...
	<div class="contentfull" onscroll="hideCharButtons();" id=contentDiv>		
		...
		<form name=quizform action="{{ route('admin.testSave') }}" method="post">
						...
						<div style="float: left; margin-bottom: 10px; width: 98%; background-color: #fefefe; border-style: solid; border-color: #CCCCCC; border-width: 1px; padding:2px;">
							<div class="column first">
								...
								<div id=maxPoints1 style="display:none;">
									Points:			
									<input type="text" size=2 style="text-align:center;" value="1" name="txtMaxPoints[1]">
								</div>
							</div>
							...
							<div class="column">
								...
								<span id=spanQuestion1>
									<textarea  name="question[1]" id="txtQuestion1" cols=50 rows=15 style="width: 100%; height:200px;" class=question>
										<p>Reorder the words to create a <a class="clozetip" title="xxxx5555" href="#">sentence</a>.<br /><br /><a class="cloze" href="#mce_temp_url#">What</a> <a class="cloze" href="#mce_temp_url#">are</a> <a class="cloze" href="#mce_temp_url#">you</a> <a class="cloze" href="#mce_temp_url#">doing</a> <a class="cloze" href="#mce_temp_url#">now</a>?</p>
									</textarea>
								</span>
							</div>
