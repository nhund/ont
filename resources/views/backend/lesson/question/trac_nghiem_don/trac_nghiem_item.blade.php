    ...
    <div class="box_text answer_box">
      <div class="box_content_t">
        ...
        <div class="box_media">
          ...
          <div class="box_image @if(isset($question->answer_ok->image) && !empty($question->answer_ok->image)) show @endif">
            <img  src="{{ isset($question->answer_ok->image) ? asset($question->answer_ok->image) : ''  }}" name="" >
            <input class="input_image" type="hidden" name="answer_img" value="{{ isset($question->answer_ok->image) ? $question->answer_ok->image : '' }}">
      ...
      <div class="box_content_t">
        ...
        <div class="box_media">
          ...
          <div class="box_image @if(!empty($question_error->image)) show @endif">
            ...
            <input class="input_image" type="hidden" name="answer_img_error[{{ $count_child }}]" value="{{$question_error->image }}">
            <p class="delete" title="Xóa ảnh" onclick="deleteImage(this)">Xóa</p>
          </div>
    ...
    <div class="box_text answer_box_error" data-child="{{ $count_child }}">
      <div class="box_content_t">
        ...
        <div class="box_media">
          ...
          <div class="box_image">
            <img  src="" name="" >
            <input class="input_image" type="hidden" name="answer_img_error[{{ $count_child }}]" value="">
            <p class="delete" title="Xóa ảnh" onclick="deleteImage(this)">Xóa</p>
          </div>
          @include('backend.lesson.question.options.action',['show_format_content'=>true,'add_answer_error'=>true,'add_answer_error_count'=>$count,'show_image'=>true,'delete_anwser'=>true])        
        </div> 
