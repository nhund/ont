          ...
          <div class="row">
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pd5">
                <ol class="breadcrumb breadcrumb-arrow">
                   ...
                   <li class="active"><span>{{ isset($var['title']) ? $var['title'] : 'Khóa học đã tạo' }}</span></li>
                </ol>
             </div>
          </div>
       </div>
    </div>
    <section id="collection" class="clearfix course_created">
       <div class="container">
          <div class="row">
                                      ...
                                      <div class="product-info">
                                         ...
                                         <p class="product-box-price clearfix flexbox-grid-default">
                                            ...
                                            @if($course->status == \App\Models\Course::TYPE_PRIVATE)
                                              <span class="price-new flexbox-content text-left">Riêng tư</span>
                                            @endif
                                         </p>
                                         ...
                                         <a target="_blank" href="{{ route('course.detail',['id'=>$course->id]) }}"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa khóa học</a>
                                      </div>
                                   </div>
                                </div>
                             </div>
