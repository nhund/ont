    ...
    <section id="course_learn" class="clearfix">
       ...
       <div id="myNav" class="overlay">
            ...
            <div class="overlay-footer footer-1">
                ...
                <a class="offer-course do-new col-xs-3 col-lg-2 col-md-2 col-sm-2 disabled" onclick="recommendationLesson(`{{str_slug($var['course']->name)}}`, `{{$var['course']->id}}`,`{{\App\Models\Question::LEARN_LAM_BAI_TAP}}`)"  title="Làm bài tập">
