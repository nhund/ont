...
@section('keywords', '222')

@push('css')

    <link href="{{ web_asset('css/posts/animate.css') }}" rel="stylesheet" type="text/css">
    <style>
        #tear {
...
@section('content')
    <div class="container posts">
        <div>
            <h1>404 Error</h1>
            <p>You have wandered into unknown regions of the interwebs</p>
...
@stop
@push('scripts')
    <script type="text/javascript" src="{{ web_asset('plugin/jquery.waypoints.min.js') }}"></script>
