        ...
        <nav class="widget-body">
            <ul class="acc-menu">
                @if(Auth::user()->level == \App\User::USER_ADMIN)
                    ...
                    <li class="hasChild"><a href="javascript:;"><i class="fa fa-anchor"></i><span>Phản hồi</span></a>
                       <ul class="acc-menu" @if(Request()->route()->getPrefix() == 'admin/founder' ? 'active':'')  style="display: block" @endif>
                           ...
                           <li><a class="{{ url()->current() == route('admin.contact.index') ? 'active':''  }}"  href="{{ route('admin.contact.index') }}"><span>Tin nhắn</span></a></li>
