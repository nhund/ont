                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="action-exam">
                                                ...
                                                <a href="{{route('exam.finish', ['title' =>str_slug($var['lesson']->name), 'id' =>$var['lesson']->id ])}}" class="btn text-uppercase replay"><i class="fa fa-arrows"></i> Kết thúc</a>
                                            </div>
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="col-xs-6" style="z-index: 10000; padding-left: 0;">
                                           <div class=" title-score">
                                               ...
                                               <span><strong class="minute-1">{{ $var['userExam']->doing_time}}</strong></span>
                                           </div>
                                       </div>
                                   </div>
                                </div>
